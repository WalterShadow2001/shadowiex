...
# ============================================
 ...
 $VersionLabel.Text = "v10.0 PROFESSIONAL"
...
# ============================================
 ...
 $ActivateDesc.Text = "Metodos de activacion - MAS y alternativas"
...
# Botones de activacion
 $ActList = @(
    @{Name="MAS INTERACTIVO"; Desc="Menu completo de activacion MAS"; Color="Success"; Mode="MAS"},
    @{Name="ACTIVAR WINDOWS"; Desc="Activacion automatica Windows TSforge"; Color="Primary"; Mode="Win"},
    @{Name="ACTIVAR OFFICE"; Desc="Activacion automatica Office Ohook"; Color="Primary"; Mode="Office"},
    @{Name="ACTIVAR TODO"; Desc="Windows + Office automatico"; Color="Success"; Mode="All"},
    @{Name="ACTIVATED.WIN"; Desc="Activador online alternativo"; Color="Secondary"; Mode="Activated"},
    @{Name="WINUTIL"; Desc="Chris Titus Windows Utility"; Color="Secondary"; Mode="WinUtil"}
)
    ...
    $Btn.Add_Click({
        switch ($ModeRef) {
            "MAS" {
                ...
                Start-Process powershell -ArgumentList "-NoProfile -ExecutionPolicy Bypass -Command `"irm https://massgrave.dev/ias | iex`"" -Verb RunAs
            }
            "Win" {
                Update-Status "Activando Windows..."
                Start-Process powershell -ArgumentList "-NoProfile -ExecutionPolicy Bypass -Command `"irm https://massgrave.dev/tsforge | iex`"" -Verb RunAs
            }
            "Office" {
                Update-Status "Activando Office..."
                Start-Process powershell -ArgumentList "-NoProfile -ExecutionPolicy Bypass -Command `"irm https://massgrave.dev/ohook | iex`"" -Verb RunAs
            }
            "All" {
                Update-Status "Abriendo activador completo..."
...
# Creditos
 ...
 $CreditTitle.Text = "SHADOWIEX v10.0 PROFESSIONAL"
...
Update-Status "SHADOWIEX v10.0 - Listo"
